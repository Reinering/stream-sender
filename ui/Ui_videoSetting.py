...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        spacerItem6 = QtWidgets.QSpacerItem(20, 182, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        spacerItem7 = QtWidgets.QSpacerItem(20, 245, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_5.setItemText(0, _translate("Dialog", "原始"))
        self.comboBox_5.setItemText(1, _translate("Dialog", "4:3"))
        self.comboBox_5.setItemText(2, _translate("Dialog", "16:9"))
        self.label_15.setText(_translate("Dialog", "图像分辨率"))
        self.comboBox_6.setItemText(0, _translate("Dialog", "原始"))
        self.comboBox_6.setItemText(1, _translate("Dialog", "1080P"))
        self.comboBox_6.setItemText(2, _translate("Dialog", "1080i"))
        self.comboBox_6.setItemText(3, _translate("Dialog", "720P"))
        self.comboBox_6.setItemText(4, _translate("Dialog", "480P"))
